...
- [X]  Complete the [Galaxy Tutorial](1-Galaxy.md) using Salmon pseudoalignment
- [X]  Complete the [SARTools Tutorial](2-SARTools.md) using DESeq2 differential expression analysis
